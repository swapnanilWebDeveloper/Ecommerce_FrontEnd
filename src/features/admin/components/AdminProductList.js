            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div>
                  <Link 
                   ...
                   className="mt-2 mx-8 w-36 flex justify-center rounded-md bg-green-600 hover:bg-green-400 px-3 py-1.5 text-sm text-white">
                      Add New Product
                  </Link>
              </div>
                ...
                <div>
                  ...
                  <div>
                    <Link
                      ...
                      className="mt-4 w-32 flex justify-center rounded-md bg-indigo-600 px-1 py-1.5 text-sm text-white">
                      Edit Product
                    </Link>
                  </div>
                </div>
