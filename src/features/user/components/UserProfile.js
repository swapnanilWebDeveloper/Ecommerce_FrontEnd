...
export default function UserProfile() {
  ...
  return (
    <div>
      {userInfo ? (
        <div className="mt-12 bg-white mx-auto max-w-4xl px-4 py-5 sm:px-6 lg:px-8">
          <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
            ...
            {userInfo.role === 'admin' && <h3 className="text-xl text-red-600 mt-4 mb-6 font-bold tracking-tight">
              role : {userInfo.role}
            </h3>}
          </div>
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                      <button
                        ...
                        type="submit"
                        className="rounded-md bg-gray-200 px-3 py-2 text-sm font-semibold text-indigo-500 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      >
                        Cancel
                      </button>
                      <button
